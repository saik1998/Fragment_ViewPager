package com.firstapp.secondnaviagation.ui.calllogs;
...
public class CalllogsFragment extends Fragment {
    ...
    int[] drawables = {R.color.purple_200, R.color.teal_700, R.color.purple_500, R.color.teal_200, R.color.purple_700,};
